    ...
    <div class="dropdown hidden sm:block sm:ml-2">
        ...
        <div class="dropdown-menu w-40">
            <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                <a href="{{ route('obat_stok') }}" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"><i class="fas fa-sync-alt mr-2"></i> Refresh</a>
            </div>
        </div>
    </div>
</div>
        ...
        <tbody>
            @foreach($obats as $obat)
                <tr class="border-b dark:border-dark-5 whitespace-nowrap text-center">
                    ...
                    <td class="font-medium"><span class="text-theme-6">{{ $obat->stok }}</span> {{ $obat->jenis }}</td>
